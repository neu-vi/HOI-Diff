...
from data_loaders.behave.motion_loaders.comp_v6_model_dataset import CompMDMGeneratedDataset, CompMDMGeneratedDatasetCondition
...
def get_mdm_loader_cond(model_dict, diffusion_dict, batch_size, ground_truth_loader,
                   ...
                   num_samples_limit, scale, seed, save_dir, afford_save_dir, skip_first_stage, wo_obj_motion):
    ...
    save_dir = os.path.join(save_dir, f'{suffix}_seed{seed:02d}')
    afford_save_dir = os.path.join(afford_save_dir, f'{suffix}_seed{seed:02d}')
    ...
    dataset = CompMDMGeneratedDatasetCondition(model_dict, diffusion_dict, ground_truth_loader,
                                      ...
                                      scale, save_dir=save_dir, afford_save_dir=afford_save_dir, skip_first_stage=skip_first_stage,
