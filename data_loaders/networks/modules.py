...
class TextEncoder(nn.Module):
    ...
    def forward(self, text):
        ...
        text_embedding = out / out.norm(dim=-1, keepdim=True) * self.latent_scale
...
class MotionEncoder(nn.Module):
    ...
    def forward(self, motions, mask):
        ...
        valid_mask = valid_mask.permute(1,0)
        ...
        motion_emb = motion_emb / motion_emb.norm(dim=-1, keepdim=True) * self.latent_scale
